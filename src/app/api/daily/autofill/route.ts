...
규칙:
- emotion: ${emotionList} 중 하나의 이모지만 선택. 전체 맥락에서 가장 지배적인 감정을 고를 것
- memorableEvent: 오늘 수행한 업무나 기억에 남는 일을 구체적으로 1~2문장으로 요약. 고객사명, 제품명, 작업 내용 등 핵심 정보를 포함할 것. 원문 복사 금지, 반드시 재요약
- hardThing: 어렵거나 힘들었던 점, 문제가 발생한 상황, 해결하지 못한 이슈를 구체적으로 1문장으로 요약. 힘든 내용이 없으면 빈 문자열 ""
- 모든 내용은 한국어로 작성
